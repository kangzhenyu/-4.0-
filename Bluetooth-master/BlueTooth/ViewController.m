...
- (void)viewDidLoad {
    ...
    if(self.centralMgr.state == CBCentralManagerStatePoweredOff) {
        // 蓝牙关闭的
        
    } else if(self.centralMgr.state == CBCentralManagerStateUnsupported) {
        // 设备不支持蓝牙
    } else if(self.centralMgr.state == CBCentralManagerStatePoweredOn ||
              self.centralMgr.state == CBCentralManagerStateUnknown) {
